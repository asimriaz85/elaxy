...
<h4>Main Category</h4>
				...
				$selectsubcategories1="SELECT id,name,show_hide,parent_off FROM categories WHERE parent_off='".$cat_id."' AND show_hide='Show' order by name asc";
				...
				?>
                    ...
                    <span class="preset_text2" id="<?php echo $subcategories1_id; ?>" onClick="javascript:display2(this.id)"><?php echo ucfirst($subcategories1name); ?></span>
