...
<div id="left_view_div_input">
   ...
   <?php 
    ...
    $select_countries="SELECT id ,country_name FROM  kingdom_countries"; 
   $run_select_counties=mysql_query($select_countries);
  while($fetch_select_countries=mysql_fetch_array($run_select_counties)){
  $country_id=$fetch_select_countries['id'];
  $country_name=$fetch_select_countries['country_name'];
  
   
   
   ?>
   		<li><a href="country_wise.php?country_id=<?php echo $country_id; ?>&sub_cat_id=<?php echo $sub_cat_id; ?>"><?php echo $country_name; ?></a></li>
   		<?php /*?><li><?php echo $subcategory_name."&nbsp;&nbsp;(".$num_rows_sub_cat.")"; ?></li><?php */?>
