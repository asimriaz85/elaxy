...
class adsens_Class {
	...
	protected static $table_name			= 'adsens_ad'; // Data base table name
	...
	public static function find_by_loc_pos($page='',$loc=''){
		global $database;
		$result_array = self::find_by_sql("SELECT * FROM " .self::$table_name. " WHERE ad_page_name='{$page}' AND location='{$loc}' AND status='Show'");
		return !empty($result_array) ? array_shift($result_array) : false;
	}// End of Function find_by_id
