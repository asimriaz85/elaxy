...
class Category_Class {
	...
	protected static $table_name			= 'categories'; // Data base table name
	...
	public static function find_by_cat_asc($cat=''){
		global $database;
		$result_array = self::find_by_sql("SELECT * FROM " .self::$table_name. " WHERE cat_url={$cat_url} order by {$name} asc");
		return !empty($result_array) ? array_shift($result_array) : false;
	}// End of Function find_by_id
