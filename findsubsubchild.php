...
<?php
	...
	include("connection.php");
		 ...
		 ?>
         <input type="hidden" name="sub_cat_child_child" value="<?php echo $sub_cat_id; ?>" />
         <?php
        ...
        <li class="blurred"  onclick="getsubsubchild_id('findsubsubchild_id.php?sub_cat_id='+<?php echo $sub_subcat_id; ?>)"><a href="#"><?php echo $category_subname; ?></a></li> 
