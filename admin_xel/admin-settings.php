...
$total_payed_ads=mysql_num_rows($result_payed);
    ...
    <td><b>Auto Trader</b></td>
    <td><?php $query_dealr=mysql_query("select count(*) as totaltrader from vehicle_make_mode where dealer='Yes'");
				$rs_dealer=mysql_fetch_array($query_dealr);
				echo $rs_dealer['totaltrader'];
	 ?></td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td>&nbsp;</td>
    <td><b>Agency</b></td>
    <td><?php $query_agency=mysql_query("select count(*) as totalagency from job_contract where empagency='Yes'");
				$rs_agency=mysql_fetch_array($query_agency);
				echo $rs_agency['totalagency'];
	 ?></td>
  </tr>
                                      </table>
<br /><br />
