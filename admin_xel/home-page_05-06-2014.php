...
?>
    ...
    <tr>
      ...
      <td><select tabindex="1" class="field select medium" name="location" > 
          <option value="">Please Select Location</option>
          <option value="Header" <?php if($location=='Header'){?> selected="selected"<?php } ?>>Header</option>
          <option value="Left" <?php if($location=='Left'){?> selected="selected"<?php } ?>>Left</option>
          <option value="Right" <?php if($ad_page_name=='Right'){?> selected="selected"<?php } ?>>Right</option>
             <option value="Bottom" <?php if($ad_page_name=='Bottom'){?> selected="selected"<?php } ?>>Bottom</option>
              <option value="undercategory" <?php if($ad_page_name=='undercategory'){?> selected="selected"<?php } ?>>Under Category</option>
