...
?>
			...
			<div id="main-content">
				...
				<div class="page-title ui-widget-content ui-corner-all">
					...
					<div class="other">
						...
						<form action="config/prime-ad-pakages.php" method="post" enctype="multipart/form-data" class="forms" name="form" >
    ...
    <tr>
      <td colspan="3" bgcolor="#4180BE"><div align="center"><strong><font color="#FFFFFF">Add New Prime Pakage </font></strong></div></td>
    </tr>
    <tr>
      <td width="13%">&nbsp;</td>
      <td width="1%">&nbsp;</td>
