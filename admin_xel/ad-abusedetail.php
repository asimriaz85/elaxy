...
$tblname='ad_abuse';
	...
	$select_abuse="SELECT id,postcode_loaction_id,feature,ad_user_id,reporter_id,reporter_id,report_datetime FROM ad_abuse WHERE id='".$id."' ";
	...
	$ad_user_id =$fetch_abuse['ad_user_id'];
		$fetchdate=$fetch_abuse['report_datetime'];
	
	
	$ad_user_email="SELECT email,id FROM registration WHERE id='".$ad_user_id."'";
...
<script type="text/javascript" src="../contact-message/js/jquery.form.js"></script> 
   ...
   ?>
    ...
    <?php /*?><div id="abuse_main">
    <div id="abuse_left2"><b><a href="edit-user.php?id=<?php echo $ad_user_id; ?>">Block User</a></b></div>
    <div id="abuse_right2"><b></b></div>
    </div><?php */?>
...
<div><button type="submit" name="send message" id="send_message_button">Block User</button></div>
</form>
</div>
  <!--END-->
