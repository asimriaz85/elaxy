                    ...
                    <input type="hidden" name="action" value="multidel">
					  <table class="display" id="example"> 
						...
						<tr> 
						    ...
						    <td>
								<a class="btn_no_text btn ui-state-default ui-corner-all " title="Edit" href="edit-town.php?id=<?php echo $id; ?>">
