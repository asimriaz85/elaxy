...
include('include/header.php');
	...
	$keywords=html_entity_decode($_REQUEST['keywords']);
	
	$meta_description=html_entity_decode($_REQUEST['meta_description']);
...
-->
    ...
    <tr>
      <td>Content:</td>
      <td>:</td>
      <td><textarea cols="80" id="editor2" name="description" rows="10">
