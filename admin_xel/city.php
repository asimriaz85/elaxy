...
?>
			...
			<div id="main-content">
				...
				<div class="page-title ui-widget-content ui-corner-all">
					...
					<div class="other">
						...
						<form action="config/city.php" method="post" enctype="multipart/form-data" class="forms" state_name="form" >
    ...
    <tr>
      <td colspan="3" bgcolor="#4180BE"><div align="center"><strong><font color="#FFFFFF">Add New Cities </font></strong></div></td>
    </tr>
    <tr>
      <td width="32%">&nbsp;</td>
      <td width="2%">&nbsp;</td>
