...
$url=$newurltitle;	
	...
	if($client_image){$categories_update="update categories set name='".$up_name."',show_hide='".$up_show_hide."',cat_url='".$url."'
...
$query_image=mysql_query($image_update) or die (mysql_error());
	 ...
	 $update_categories11="UPDATE categories SET name='".$up_name."',show_hide='".$up_show_hide."',cat_url='".$url."' WHERE id='$id'";
