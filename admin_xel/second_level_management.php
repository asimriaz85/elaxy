 ...
 <script type="text/javascript">
	...
	<div id="page-wrapper">
                    ...
                    <input type="hidden" name="action" value="multidel">
					  <table class="display" id="example"> 
						...
						while($fetch_categories=mysql_fetch_array($select_query)){
							...
							$select_sub_main_cat="SELECT id,name,parent_off FROM categories WHERE id='".$parent_off."'";
							$run_sub_select_main=mysql_query($select_sub_main_cat);
							$fetch_submain_cat=mysql_fetch_array($run_sub_select_main);
							$submain_cat=$fetch_submain_cat['name'];
							$submain_parent_off=$fetch_submain_cat['parent_off'];
							
							$select_main_cat="SELECT id,name FROM categories WHERE id='".$submain_parent_off."'";
							$run_select_main=mysql_query($select_main_cat);
							$fetch_main_cat=mysql_fetch_array($run_select_main);
							$main_cat=$fetch_main_cat['name'];
						...
						<tr> 
						    ...
						    <td><?php echo $main_cat; ?></td>
						    <td><?php echo $submain_cat; ?></td>
		...
		<tr>
			...
			<th><input type="text" name="search_browser3" value="Category Name" class="search_init" /></th>
			<th><input type="text" name="search_browser2" value="Subcategory Name" class="search_init" /></th>
