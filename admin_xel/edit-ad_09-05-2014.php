...
$first_name=$_REQUEST['first_name'];
  ...
  <tr>
    <td><p>Elaxy are pleased to inform you that your ad has been reviewed and is now active. If you wish to edit or manage any of your ads, simply click <strong>my Elaxy</strong>. after logging in, go to <strong>manage my ads</strong> and then edit. Please be sure to click approve so that any changes become active instantly. We'."'".'re happy to answer any queries you may have via our email address Info@elaxy.co.uk.</p></td>
