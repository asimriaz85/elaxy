				...
				$user_email=$fetch_users['email'];			
						...
						<tr> 
						    ...
						    <td>
								...
								</a><a class="btn_no_text btn ui-state-default ui-corner-all " title="Delete" href="config/delete-all.php?id=<?php echo $add_id; ?>&action=<?php echo "delete";?>&tblname=ad_price&page_name=<?php echo $page_name; ?>" onclick="javascript:return confirm('Are you sure you want to delete this?')">
