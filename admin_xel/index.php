...
?>
		...
		<form action="loginchk.php" method="post" enctype="multipart/form-data" class="forms" name="form">
			<ul>
				<li>
                    ...
                    <input type="text" tabindex="1" maxlength="255" value="" class="field text full" name="user" id="email" />
				...
				<li>
                    ...
                    <input type="password" tabindex="1" maxlength="255"  class="field text full" name="pass" id="password" />
	...
	<input type="hidden" name="sublogin" value="1">
                      <input type="submit"  name="login" id="saveForm" value="Login" class="ui-state-default ui-corner-all" style=" height:30px;" />
                    </div>
			  </li>
			</ul>
		</form>
