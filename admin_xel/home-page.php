...
?>
    ...
    <tr>
      ...
      <td><select tabindex="1" class="field select medium" name="ad_page_name" >
        ...
        <option value="View" <?php if($ad_page_name=='Category'){?> selected="selected"<?php } ?>> Category Listing Page </option>
      
        <option value="Detail" <?php if($ad_page_name=='AdView'){?> selected="selected"<?php } ?>> Ad View Page </option>
      
        
         <option value="Logout" <?php if($ad_page_name=='Logout'){?> selected="selected"<?php } ?>> Logout </option>
      </select></td>
    </tr>
    <tr>
      ...
      <td><select tabindex="1" class="field select medium" name="location" > 
          <option value="">Please Select Location</option>
          <option value="Header" <?php if($location=='Header'){?> selected="selected"<?php } ?>>Header 728 x 90</option>
          <option value="Left600" <?php if($location=='Left'){?> selected="selected"<?php } ?>>Left 160 x 600</option>
          <option value="Left100" <?php if($location=='Left'){?> selected="selected"<?php } ?>>Left 160 x 100</option>
          <option value="Right600" <?php if($ad_page_name=='Right'){?> selected="selected"<?php } ?>>Right 160 x 600</option>
             <option value="Right100" <?php if($ad_page_name=='Right'){?> selected="selected"<?php } ?>>Right 160 x 100</option>
             <option value="Bottom" <?php if($ad_page_name=='Bottom'){?> selected="selected"<?php } ?>>Bottom 728 x 90</option>
              <option value="undercategory" <?php if($ad_page_name=='undercategory'){?> selected="selected"<?php } ?>>Under Category 300 x 250</option>
