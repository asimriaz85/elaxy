...
*/
				...
				$post_email=$_REQUEST['sender_email'];
				
				$sender_email=$_REQUEST['post_email'];
				
				$select_post_email="SELECT id,email FROM  registration WHERE email='".$post_email."'";
				 $run_post_email=mysql_query($select_post_email);
				 $fetch_post_email=mysql_fetch_array($run_post_email);
				 
				 $s_user=$fetch_post_email['id'];
				...
				$fetch_user=mysql_fetch_array($run_user);
				  echo  $s_user=$fetch_user['user_id'];
