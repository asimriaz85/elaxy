...
<div class="left_ad" style="width:160px;">&nbsp;<?php if(!empty($left_ad['AdCode'])){ echo $left_ad['AdCode']; } else if(!empty($left_ad['Image'])){?><img src="admin_xel/media/upl_gallery/<?php echo $left_ad['Image']; ?>"> <?php } ?>
...
<div class="right_ad_home"><?php if(!empty($ad_code_right)){ echo $ad_code_right; } else if(!empty($adsen_right_image)){?><img src="admin_xel/media/upl_gallery/<?php echo $adsen_right_image; ?>"> <?php } ?> 
...
<h2>Recently viewed ads <span style="float:right;"><img src="/images/clear.png" width="16" height="16"><a href="/clear-history.php?emptycart=1&return_url=http://elaxy.co.uk">Clear history</a></span></h2>
