...
require_once('inc/header.php'); 
	...
	$select_pname="SELECT id,name FROM categories WHERE id='".$parent_off."' ORDER BY name ASC";
...
<?php 
	...
	include("inc/property-search.php");
	 if(!empty($right_ad['AdCode'])){ echo $footer_ad['AdCode']; } else if(!empty($right_ad['Image'])){?><img src="admin_xel/media/upl_gallery/<?php echo $right_ad['Image']; ?>"> <?php }
	}
