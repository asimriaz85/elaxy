...
INNER JOIN ad_title_description ON ad_title_description.postcode_loaction_id = postcode_location.id WHERE  postcode_location.status ='0' AND postcode_location.user_id='".$user_id."' order by postcode_location.date desc";	
...
<div id="tabs_area">
	...
	<div id="main">
		...
		<div id="contents">
			...
			?>
                  ...
                  <table width="1026" class="pure-table pure-table-bordered">
    ...
    <thead>
        ...
        <tr>
            ...
            <th width="114">Title</th>

            <th width="162">Description</th>

            <th width="142">Date Published</th>

            <th width="103">Status</th>

            <th width="78">Views</th>

             <th width="107">Replies</th>

             <th width="209">Options</th>
...
$description=$row['description'];
		...
		$cdate=date('Y-m-d');
		 ...
		 $select_post_id="SELECT id FROM postcode_location WHERE id='".$add_id."'";
