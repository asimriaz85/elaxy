...
$row_sub2_ad = mysql_fetch_array($result_sub2_ad);
	...
	$cat_name4_id=$fetch_cat_id4['id'];
		...
		$sql_contact_option=mysql_query("select * from contact_via where postcode_loaction_id='".$postcode_loaction_id."'");
