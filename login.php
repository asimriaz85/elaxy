<?php session_start();
if(!empty($_SESSION['login_email_id'])){ header("location:manage_ads.php");}
?>
<!DOCTYPE html>
<html>
<head>
...
<section class="main-wrapper">
  ...
  <div class="signup">
    ...
    <div class="signup" style="border-top:none;">
      <div class="form-area">
        <div style="width:500px; margin-left:250px; margin-top:20px; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
          <form class="pure-form pure-form-aligned" method="post" action="config/login.php">
            <fieldset>
              <?php if(isset($_SESSION['error'])){?>
              <div id="error" style="color:#F00; margin-left:50px; text-align:center; font-weight:bold; margin-bottom:10px;"> <?php echo $_SESSION['error'];  ?></div>
              <?php } ?>
              ...
              <div class="pure-controls" id="keeplogin_div">
                <label for="cb" class="pure-checkbox black_color">
                  <input id="cb" type="checkbox" class="black_color">
                  Keep me Signed in </label>
                <button type="submit" class="pure-button pure-button-primary black_color" name="Login">Sign in</button>
                <label class="pure-checkbox black_color"> Log in Problem ? </label>
                <label style="color:#000;"><span><a href="forgot-password.php" style="color:#000;"><strong>Recover password</strong></a></span> or <span><a href="create-account.php" style="color:#000;"><strong>Create a new account</strong></a></span></label>
              </div>
            </fieldset>
          </form>
        </div>
