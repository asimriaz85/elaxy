...
<div class="catContainer">
        ...
        <div class="catSelect selected">
             ...
             <div class="Right">
             <div style="color:#F00; font-weight:bold; font-size:14px;"><?php if(isset($_REQUEST['msg'])){ echo $msg=$_REQUEST['msg']; } ?></div>
             	<h4>Your Selected Category <a href="post-ad1.php">(back to change or edit)</a></h4>
             	<div class="catHolder">
                	<span class="selected"><?php echo ucfirst($cat_maincat_name); ?></span><span><?php echo ucfirst($cat_name1); ?> </span><?php if(!empty($cat_name2)){ ?><span><?php echo ucfirst($cat_name2); ?></span><?php } if(!empty($cat_name3)){ ?> <span><?php echo ucfirst($cat_name3); ?></span><?php } if(!empty($cat_name4)){ ?><span><?php echo ucfirst($cat_name4); ?></span><?php } ?>
                </div>                                            
             </div>
		...
		<input type="hidden" name="address1"/>	
 		...
 		<input type="hidden" name="address3"/>	
	  	...
	  	<input type="text" name="town" id="ValidField01"/>		
    ...
    <!--END-->
             ...
             <!--/////////////////////-->
    <?php 
	if($cat_name2=="Holiday Rentals" && $cat_maincat_name!="Jobs"){
    ...
    <?php /*?><?php if($cat_name1=='To Share' && $cat_name2=='share wanted'){
        ...
        <!--//////-->
        <?php 
	if($cat_name2=="Office Space" && $cat_name3!="Office Space Wanted"){
	?>
    <div class="Right">
             	<h4>Property details</h4>
             	<div class="catHolder">
   ...
   <input type="radio" name="dealer" value="Yes" />Yes&nbsp;&nbsp;<input type="radio" name="dealer" value="No" />No
    ...
    <div class="catHolder">
                ...
                <div class="Right">
             	...
             	<div class="catHolder">
                	<label>Make<b>*</b>:</label>
                	<?php $select_make="SELECT id,name,show_hide,parent_off FROM categories WHERE parent_off='38'";
	$run_make=mysql_query($select_make);
	?>
    <select name="make" id="ValidSelection">
                ...
                <div class="Right">
             	...
             	<div class="catHolder">
                	...
                	<?php
					 ...
					 $select_make="SELECT id,name,show_hide,parent_off FROM categories WHERE parent_off='38'";
	$run_make=mysql_query($select_make);
	?>
    <select name="make" id="ValidSelection">
   ...
   <input type="radio" name="dealer" value="Yes" />Yes&nbsp;&nbsp;<input type="radio" name="dealer" value="No" />No
    ...
    <div class="catHolder">
                	<label>Contract<b>*</b>:</label>
                     <span id="ValidRadio" class="InputGroup">
   <input type="radio" name="jobcontract" value="Permanent" />Permanent&nbsp;&nbsp;<input type="radio" name="jobcontract" value="Temporary" />Temporary
   </span>
         ...
         <?php } }?>
             ...
             <div class="Right">
             	...
             	<div class="catHolder">
                	...
                	<input name="name" type="text" readonly value="<?php echo $session_first_name; ?>"/><p></p>                <br><br><br>
                	<label><input type="checkbox" name="via_email" checked="checked" value="<?php echo $session_email; ?>" /> Via email on</label>
                	<input name="email" type="text" readonly value="<?php echo $session_email; ?>"/><p>Your email address won't appear on your ad</p>
                	<label><input type="checkbox" name="via_phone"  value="<?php echo $session_phone; ?>" /> By phone on</label>
                    
                    
                	<input name="phone" type="text" readonly value="<?php echo $session_phone; ?>"/><p>you phone number will be shown on ad</p>                
                </div>                                            
             </div>   
             <!--<div class="Right">
             ...
             <div class="Right">
             	<div class="catHolder">
                	<label style="width:60%; line-height:42px;">By clicking 'Post my ad', you agree to Elaxy's terms of use and posting rules</label>
...
<div class="clear"></div>
<div class="right_ad" style="top:-5px;"><?php if(!empty($ad_code_right)){ echo $ad_code_right; } else if(!empty($adsen_right_image)){?><img src="ksdh348_@iy/media/large_gallery/<?php echo $adsen_right_image; ?>"> <?php } ?> </div>
</div>
</section>
<div class="clear"></div>
