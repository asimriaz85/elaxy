...
//	$insert1="INSERT INTO postcode_location(user_id,main_cat_id,sub_cat_id,sub_sub_cat,sub_cat_child_child,sub_cat_child_child_child,postcode,companyname,house_name,town,map,date,item_price)VALUES('".$user_id."','".$main_cat."','".$sub_cat_id."','".$sub_sub_cat."','".$sub_cat_child_child_child."','".$sub_cat_child_child_child."','".$postcode."','".$companyname."','".$house_name."','".$town."','".$mape."','".$cdate."','".$price."')";
	...
	$insert1="INSERT INTO postcode_location  SET user_id='".$user_id."',main_cat_id='".$main_cat."',postcode='".$postcode."',companyname='".$companyname."',house_name='".$house_name."',town='".$town."',map='".$mape."',date='".$cdate."',item_price='".$price."',lat='".$lan_lot['lat']."',lang='".$lan_lot['lng']."'";
...
$urltitle=preg_replace('/[^a-zA-Z0-9.,&]/i',' ', $newtitle);



$newurltitle=str_replace(" ","-",$newtitle);

$url=$newurltitle."-".$max_id;
...
$days = (strtotime($onemonth) - strtotime($cdate)) / (60 * 60 * 24);
	...
	///Job Contract query///
	 ...
	 $insert_job_contract="INSERT INTO job_contract(postcode_loaction_id,job_contract,salary,paytype,empagency)VALUES('".$max_id."','".$jobcontract."','".$price."','".$_REQUEST['paytype']."','".$_REQUEST['empagency']."')";
