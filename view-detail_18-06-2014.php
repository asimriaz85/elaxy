...
$sql_sb=mysql_query("select sub_cat_id from postcode_location where id ='".$newpostid."'");
$rs_sb=mysql_fetch_array($sql_sb);

$sub_cat_id=$rs_sb['sub_cat_id'];
  ...
  <div class="view-ad">
    ...
    <div class="widget2">
      ...
      <div style="margin-bottom:10px;">
        ...
        <?php if(!empty($rs_contact_option['via_phone'])){ ?> <a href="#" id = "div2" style="display:none;" class="btn btn-default"><i class="glyphicon glyphicon-phone"></i> <?php echo $phone; ?></a> <a href="#" id= "div1" onclick = "replace()" class="btn btn-default"><i class="glyphicon glyphicon-phone"></i> <?php echo substr($phone,0, -4).'&nbsp;XXXX'; ?></a> <?php } ?><a href="/config/getfavourite.php?post_id=<?php echo $newpostid; ?>&f_id=<?php echo $f_id; ?>&feature=<?php echo $feature; ?>&url=<?php echo $_GET['url']; ?>uid=<?php echo $user_id; ?>&sub_cat_id=<?php echo $sub_cat_id; ?>" class="btn btn-default"><i class="glyphicon glyphicon-star"></i> Favourite</a> <a href="report_message.php?post_id=<?php echo $post_id; ?>&f_id=<?php echo $f_id; ?>&feature=<?php echo $feature; ?>&ad_userid=<?php echo $u_id; ?>&sub_cat_id=<?php echo $sub_cat_id; ?>&reporter_id=<?php echo $user_id; ?>" onclick="return popitup('/report_message.php?post_id=<?php echo $newpostid; ?>&f_id=<?php echo $f_id; ?>&feature=<?php echo $feature; ?>&ad_userid=<?php echo $u_id; ?>&sub_cat_id=<?php echo $sub_cat_id; ?>&reporter_id=<?php echo $user_id; ?>')" class="btn btn-default"><i class="glyphicon glyphicon-flag"></i> Report Ad</a> </div>
      <div class="clear"></div>
