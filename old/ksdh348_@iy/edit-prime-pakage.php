...
$id=$_REQUEST['id'];
			...
			if(isset($_REQUEST['submit'])){
				...
				$update="UPDATE  prime_price SET days='".$up_days."',price='".$up_price."' WHERE id='".$id."'";
		...
		$select_feature_pakage="SELECT id,days,price FROM  prime_price WHERE id='".$id."'";
...
?>
    ...
    <tr>
      <td colspan="3" bgcolor="#4180BE"><div align="center"><strong><font color="#FFFFFF">Edit Prime Pakage </font></strong></div></td>
    </tr>
    <tr>
      <td width="13%">&nbsp;</td>
      <td width="1%">&nbsp;</td>
