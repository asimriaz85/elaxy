...
include "gd_engine/gdengin.php";
	...
	if($client_image){$categories_update="update categories set name='$up_name',show_hide='$up_show_hide',parent_off='$up_parent_off' where id='$id'" or die (mysql_error());

$image_update="UPDATE categories_image SET image='$client_image' WHERE cat_id='$id'" or die (mysql_error());
...
$query_image=mysql_query($image_update) or die (mysql_error());
	 ...
	 $update_categories11="UPDATE categories SET name='$up_name',show_hide='$up_show_hide',parent_off='$up_parent_off' WHERE id='$id'";
