                    ...
                    <input type="hidden" name="action" value="multidel">
					  <table class="display" id="example"> 
						...
						<tr>
						    ...
						    <th width="154">Phone</th>
                            <th width="154">Email</th>
                            <th width="154">NewsLetter</th>
						...
						<tbody> 
                        <?php $select_query=mysql_query("SELECT * FROM registration ORDER BY id"); 
						$row=mysql_num_rows($select_query);
						while($fetch_user=mysql_fetch_array($select_query)){
						...
						<tr> 
                            ...
                            <td> <?php if($newsletter==1){ echo "Subscribe"; } if($newsletter==0){ echo "Not Subscribed"; } ?></td>
                            
                            <td> <?php if($status==1){ echo "Active"; } if($status==0){ echo "Not Active"; } ?></td>
                            
                            <td> <?php echo $date; ?></td>
                             
						    
						    <td>
								<a class="btn_no_text btn ui-state-default ui-corner-all " title="Edit" href="edit-user.php?id=<?php echo $id; ?>">
