...
include "gd_engine/gdengin.php";
	...
	if($client_image){$categories_update="update categories set name='$up_name',show_hide='$up_show_hide'
...
$query_image=mysql_query($image_update) or die (mysql_error());
	 ...
	 $update_categories11="UPDATE categories SET name='$up_name',show_hide='$up_show_hide' WHERE id='$id'";
...
$msg="Update Successfully If Image Not change Please Refresh the page";	
	...
	//End//
			...
			$select="SELECT id,name,show_hide FROM categories WHERE id='".$id."'";
