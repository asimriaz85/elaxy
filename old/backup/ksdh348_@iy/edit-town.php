...
include('include/header.php');
 ...
 $id=$_REQUEST['id'];
 		...
 		if(isset($_REQUEST['submit'])){
			...
			$up_town_name=$_REQUEST['town_name'];
			
			if(!empty($up_county_id) && !empty($up_town_name)){
				
				 $update="UPDATE town SET county_id='$up_county_id',town_name='$up_town_name' WHERE id='$id'";
	...
	$select="SELECT id,county_id,town_name FROM town WHERE id='".$id."'";
	$run=mysql_query($select);
	$fetch=mysql_fetch_array($run);
	$county_id01=$fetch['county_id'];
	$town_name=$fetch['town_name'];
...
?>
    ...
    <tr>
      <td colspan="3" bgcolor="#4180BE"><div align="center"><strong><font color="#FFFFFF">Edit Town </font></strong></div></td>
    </tr>
    <tr>
      <td width="32%">&nbsp;</td>
      <td width="2%">&nbsp;</td>
