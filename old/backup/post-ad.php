...
<div class="catContainer">
    ...
    <!--END-->
             ...
             <!--/////////////////////-->
    <?php 
	if($cat_name2=="Holiday Rentals" || $cat_name2=="Rental Offered"){
    ...
    <!--/////////////////////////////////-->
     <?php 
	if($cat_name2=="Office Space" && $cat_name3=="Space Wanted"){
	?>
    <div class="Right">
             	<h4>Property details</h4>
             	<div class="catHolder">
    ...
    <?php 
	if($cat_name2=="Parking" && $cat_name3=="Wanted Parking"){
	?>
    <div class="Right">
             	<h4>Property details</h4>
             	<div class="catHolder">
