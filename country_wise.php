...
include("include/header.php");
	 ...
	 $sub_cat_id=$_REQUEST['sub_cat_id'];
	   $country_id01=$_REQUEST['country_id'];
	   $state_id=$_REQUEST['state_id'];
	  
	  if(!empty($country_id01)){
		  
		$statement1="AND postcode_location.country=$country_id01";  
	  }
	  
	  if(!empty($state_id)){
		  
		$statement2="AND postcode_location.state=$state_id";  
	  }
...
<div id="wrapper2">
    ...
    <!--Left Side-->
    <?php 
	include("include/country_left_side.php");
	...
	*/
	...
	$targetpage = "country_wise.php"; 	//your file name  (the name of this file)
...
AND postcode_location.sub_cat_id = '".$sub_cat_id."' $statement1 $statement2 LIMIT $start, $limit";	
