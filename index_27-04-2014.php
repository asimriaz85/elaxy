...
<div style="float:left;" class="veicals">
	 ...
	 $select="SELECT id,name FROM categories WHERE parent_off='0' AND show_hide='Show' ORDER BY name asc LIMIT 0,5";
...
<div class="car"><img src="admin_xel/media/logo_gallery/<?php echo $image; ?>" alt="<?php echo $name; ?>"  /></div>
       ...
       <div class="clear"></div> 
        ...
        <ul>
        <?php
	 $select_sub_categories="SELECT id,name FROM categories WHERE parent_off='".$id."' AND show_hide='Show' ORDER BY name asc";
	...
	?>
        <li><a href="view.php?sub_cat_id=<?php echo $sub_cat_id; ?>&sub_cat_name=<?php echo $sub_cat_name;?>&df=sub_cat_id"><?php echo $sub_cat_name; ?></a></li>
...
<?php } ?>
	 ...
	 $select="SELECT id,name FROM categories WHERE parent_off='0' AND show_hide='Show' ORDER BY name asc LIMIT 5,2";
	$run=mysql_query($select);
	while($fetch=mysql_fetch_array($run)){
...
<?php } ?>
	 ...
	 $select="SELECT id,name FROM categories WHERE parent_off='0' AND show_hide='Show' ORDER BY name asc LIMIT 7,15";
	$run=mysql_query($select);
	while($fetch=mysql_fetch_array($run)){
