...
<?php
	...
	include("connection.php");
		 ...
		 ?>
         <input type="hidden" name="sub_sub_cat" value="<?php echo $sub_cat_id; ?>" />
         <?php
		...
		?>
                                   ...
                                   <li class="blurred"  onclick="getsubsubchild('findsubsubchild.php?sub_cat_id='+<?php echo $sub_subcat_id; ?>)"><a href="#"><?php echo $category_subname; ?></a></li> 
